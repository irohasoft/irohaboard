...
<div class="admin-contents-questions-index">
	...
	<tr>
		...
		<th nowrap><?php echo __('選択肢'); ?></th>
		<th nowrap><?php echo __('正解'); ?></th>
		<th nowrap><?php echo __('得点'); ?></th>
		<th nowrap class="ib-col-date"><?php echo __('作成日時'); ?></th>
		<th nowrap class="ib-col-date"><?php echo __('更新日時'); ?></th>
		<th nowrap class="actions text-center"><?php echo __('Actions'); ?></th>
	</tr>
	</thead>
	<tbody>
	<?php foreach ($contentsQuestions as $contentsQuestion): ?>
	<tr>
		<td nowrap class="td-reader"><?php echo h($contentsQuestion['ContentsQuestion']['title']); ?>&nbsp;</td>
		<td nowrap class="td-reader"><?php echo h(strip_tags($contentsQuestion['ContentsQuestion']['body'])); ?>&nbsp;</td>
		<td nowrap class="td-reader"><?php echo h($contentsQuestion['ContentsQuestion']['options']); ?>&nbsp;</td>
		<td nowrap><?php echo h($contentsQuestion['ContentsQuestion']['correct']); ?>&nbsp;</td>
		<td nowrap><?php echo h($contentsQuestion['ContentsQuestion']['score']); ?>&nbsp;</td>
		<td nowrap class="ib-col-date"><?php echo Utils::getYMDHN($contentsQuestion['ContentsQuestion']['created']); ?>&nbsp;</td>
		<td nowrap class="ib-col-date"><?php echo Utils::getYMDHN($contentsQuestion['ContentsQuestion']['modified']); ?>&nbsp;</td>
		<td nowrap class="actions text-center">
			<?php
